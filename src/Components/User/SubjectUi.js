                    ...
                    {subjects.map(
                        (subject, i) => (
                            <div key={i} className="col card-hover shadow-none bg-none position-relative mb-4 mb-lg-5">
                                ...
                                {  
                                         ( subject && subject.node_id && (subject.display_name == "exam preparation testing") )
                                         ?
                                         <>
                                         ...
                                         onClick={() => 
                                            ...
                                            navigate("/ExamPrepTest", { state: { node_id: subject.node_id } })} 
                                            className="stretched-link"> {subject.display_name} 
